    ...
    def __getitem__(self, idx):
        ...
        for img_idx in range(self.out_len):
            image_path = os.path.join(self.root_path, 
                                str(self.trial_folders[video_number]), 
                                f"{self.data_file_name}_{frame_start+img_idx}{self.ext}")
...
class RFData(Dataset):
    def __init__(self, root_path, trial_folders, \
        ...
        self.rf_data_list = []
        for rf_file in self.trial_folders:
            ...
            # TODO: Check data and add  overriding functionality.
...
class SignalDataset(Dataset):
    def __init__(self, root_path, trial_folders, vital_dict_file, 
        ...
        # TODO: Use these for the FFT pre-processing.
        # FFT Attributes 
        ...
        # freqs_bpm = np.fft.fftfreq(nfft, d=1/self.fs) * 60
