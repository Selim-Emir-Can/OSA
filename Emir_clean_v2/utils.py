...
def save_video(dataset_thermal_train, index, path="E:\OSA_project"):
...
def plot_envelope(t_arr, thermal, dmin=1, dmax=1):
    lmin, lmax = hl_envelopes_idx(thermal, dmin_num=dmin, dmax_num=dmax)
...
def movement_detector_radar(thermal, dmin=29, dmax=31, plot=False, gt_breathing=None, include_edges=False):
